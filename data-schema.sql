...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='When the users get assigned to the specific contacts this table will be used';
...
ALTER TABLE `contact_users`
  ADD PRIMARY KEY (`_id`),
  ADD UNIQUE KEY `_uid` (`_uid`),
  ADD KEY `fk_contact_users_contacts1_idx` (`contacts__id`),
  ADD KEY `fk_contact_users_users1_idx` (`users__id`);
...
--
ALTER TABLE `contact_users`
  ADD CONSTRAINT `fk_contact_users_contacts1` FOREIGN KEY (`contacts__id`) REFERENCES `contacts` (`_id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_contact_users_users1` FOREIGN KEY (`users__id`) REFERENCES `users` (`_id`) ON DELETE CASCADE ON UPDATE NO ACTION;
