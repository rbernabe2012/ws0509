    ...
    customButtons:{
        ...
        if (buttonType == 'QUICK_REPLY') {
            btnData = {
                buttonType : buttonType,
                buttonText: '',
                buttonIndex : this.totalButtonsUsed
            };
        }
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        <template
                                                                            ...
                                                                            <x-lw.input-field x-bind:id="customButton.buttonIndex"
                                                                                ...
                                                                                x-bind:value="carouselTemplateContainer[index]['cardButtons']['data'][buttonIndex]['buttonText']">
                                                                                <x-slot name="prepend">
                                                                        ...
                                                                        <template x-if="customButton.buttonType == 'PHONE_NUMBER'">
                                                                            <div>
                                                                                ...
                                                                                <x-lw.input-field x-bind:id="customButton.buttonIndex"
                                                                                    ...
                                                                                    x-bind:value="carouselTemplateContainer[index]['cardButtons']['data'][buttonIndex]['phoneNumber']">
                                                                                    <x-slot name="prepend">
                                                                        ...
                                                                        <template x-if="customButton.buttonType == 'URL'">
                                                                            <div>
                                                                                <x-lw.input-field x-bind:id="customButton.buttonIndex"
                                                                                    ...
                                                                                    x-bind:value="carouselTemplateContainer[index]['cardButtons']['data'][buttonIndex]['url']">
                                                                                    <x-slot name="prepend">
                                                                                ...
                                                                                <x-lw.input-field x-bind:id="customButton.buttonIndex"
                                                                                    ...
                                                                                    x-bind:value="carouselTemplateContainer[index]['cardButtons']['data'][buttonIndex]['example']">
                                                                                    <x-slot name="append">
                                                                                        <span class="input-group-text">@{{1}}</span>
                                                                                    </x-slot>
                                                                                </x-lw.input-field>
