...
<x-lw.modal id="lwAddNewAdvanceBotReply" modal-dialog-class="modal-lg lw-modal-xl" :header="__tr('Add New Bot Reply')" :hasForm="true">
...
<x-lw.modal id="lwEditBotReply" modal-dialog-class="modal-lg lw-modal-xl" :header="__tr('Edit Bot Reply')" :hasForm="true">
    <!--  Edit Bot Reply Form -->
    <x-lw.form id="lwEditBotReplyForm" :action="route('vendor.bot_reply.write.update')"
        ...
        <% if(__tData.__data?.template_message) { %>
            ...
            <div x-data="{ selectedTemplate: '<%= __tData.__data?.template_message?.template_data?.inputs?.template_uid %>', onTemplateChange() {
                        ...
                        if (!_.isEmpty(this.selectedTemplate)) {
                            __DataRequest.post('{{ route('vendor.request.template.view') }}', {
                                ...
                                $('#lwTemplateStructureEditContainer').html(responseData.response_action.content);
